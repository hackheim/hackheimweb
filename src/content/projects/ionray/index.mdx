...
tags: ["High Voltage"]
featured: true
coverImage: "./pictures/demo.jpg"
---

import ZoomImage from '@components/ui/ZoomImage.astro';
import bookCover from "./pictures/book_cover.jpg";
import catalogCover from "./pictures/catalog_cover.jpg";
import catalogPage from "./pictures/catalog_page.jpg";
...
<ZoomImage src={bookCover} width="900"/>
...
<ZoomImage src={catalogCover} width="900"/>
<ZoomImage src={catalogPage} width="900"/>
...
<ZoomImage src={circuit} width="900"/>
