---
title: "Ionepistol for hvermansen"
description: "Verdens farligste postordrebutikk"
author: "Hans Jørgen Grimstad"
date: 2024-10-29
tags: ["Robot", "Design", "Elektronikk", "Dynamixel", "Cybergear", "IMU"]
type: "showcase"
featured: true
difficulty: "advanced"


coverImage: "./pictures/catalog_page.jpg"
...
import cover from "./pictures/book_cover.jpg";

<div style="text-align: center;">
<Image src={cover} alt="Book cover" width="720"/>
</div>
...
import catalog_cover from "./pictures/catalog_cover.jpg";
import catalog_page from "./pictures/catalog_page.jpg";

<div style="text-align: center;">
<Image src={catalog_cover} alt="Catalog cover" width="720"/>
<Image src={catalog_page} alt="Catalog page" width="720"/>
</div>
...
import circuit from "./pictures/circuit.jpg";

<div style="text-align: center;">
<Image src={circuit} alt="Circuit" width="720"/>
</div>
...
import demo from "./pictures/demo.jpg";

<div style="text-align: center;">
<Image src={demo} alt="Demo" width="720"/>
</div>
